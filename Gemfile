...
gem 'solidus_globalize', git: 'https://github.com/solidusio-contrib/solidus_globalize', branch: 'master'
...
gem 'solidus_import_products', git: 'https://github.com/2beDigital/solidus_import_products', ref: '0715790a6306fc40adbf2b20abf61f23d7e0ae8b'
